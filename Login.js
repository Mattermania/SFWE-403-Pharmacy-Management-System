...
//New implementation
// Inside the catch block of the login request
if (error.response.status === 423) {
    setErrorMessage('Your account is locked due to too many failed login attempts. Please contact a manager to unlock your account.');
